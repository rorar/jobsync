...
const core = {
  en: {
    ...
    "errors.statusInUse": "This status is in use by jobs — choose a status to move them to first",
    "errors.cannotDeleteDefaultStatus": "Set a different default status before deleting this one",
    "errors.cannotDeleteLastStatus": "You must keep at least one status",
    "errors.statusLabelRequired": "Status name is required",
    ...
    "errors.notAuthorized": "Not authorized to perform this action",
  ...
  de: {
    ...
    "errors.statusInUse": "Dieser Status wird von Jobs verwendet — wähle zuerst einen Status, auf den sie verschoben werden",
    "errors.cannotDeleteDefaultStatus": "Lege einen anderen Standardstatus fest, bevor du diesen löschst",
    "errors.cannotDeleteLastStatus": "Es muss mindestens ein Status erhalten bleiben",
    "errors.statusLabelRequired": "Statusname ist erforderlich",
    ...
    "errors.notAuthorized": "Nicht berechtigt, diese Aktion auszuführen",
    "errors.tooManyRequests": "Zu viele Anfragen, bitte versuchen Sie es später erneut",
  ...
  fr: {
    ...
    "errors.statusInUse": "Ce statut est utilisé par des offres — choisissez d'abord un statut vers lequel les déplacer",
    "errors.cannotDeleteDefaultStatus": "Définissez un autre statut par défaut avant de supprimer celui-ci",
    "errors.cannotDeleteLastStatus": "Vous devez conserver au moins un statut",
    "errors.statusLabelRequired": "Le nom du statut est requis",
    ...
    "errors.notAuthorized": "Non autorisé à effectuer cette action",
  ...
  es: {
    ...
    "errors.statusInUse": "Este estado está en uso por empleos: elige primero un estado al que moverlos",
    "errors.cannotDeleteDefaultStatus": "Establece otro estado predeterminado antes de eliminar este",
    "errors.cannotDeleteLastStatus": "Debes mantener al menos un estado",
    "errors.statusLabelRequired": "El nombre del estado es obligatorio",
    ...
    "errors.notAuthorized": "No autorizado para realizar esta acción",
    "errors.tooManyRequests": "Demasiadas solicitudes, por favor inténtalo de nuevo más tarde",
