export const automations = {
  en: {
    ...
    // Sprint 2 Stream G (H-Y-03 / H-Y-04 / H-Y-05) — ARIA names for
    // icon-only controls on the discovered jobs table. Each receives
    // the job title + employer as context so screen reader users know
    // which row the action targets.
    "automations.discoveredJob.acceptAria": "Accept job {job}",
    "automations.discoveredJob.dismissAria": "Dismiss job {job}",
    "automations.discoveredJob.viewDetailsAria": "View details for job {job}",
    "automations.discoveredJob.externalLinkAria": "Open job {job} on the original site in a new tab",
    ...
    "automations.unknownModule": "Unknown job board module",
    "automations.invalidConnectorParams": "Invalid search parameters",
    "automations.cannotDeleteRunning": "You can't delete an automation while it's running.",
    "automations.moduleNotFound": "Module not found",
  ...
  de: {
    ...
    "automations.discoveredJob.acceptAria": "Stelle {job} annehmen",
    "automations.discoveredJob.dismissAria": "Stelle {job} ablehnen",
    "automations.discoveredJob.viewDetailsAria": "Details für Stelle {job} anzeigen",
    "automations.discoveredJob.externalLinkAria": "Stelle {job} in neuem Tab auf der Originalseite öffnen",
    ...
    "automations.unknownModule": "Unbekanntes Jobbörsen-Modul",
    "automations.invalidConnectorParams": "Ungültige Suchparameter",
    "automations.cannotDeleteRunning": "Du kannst eine Automatisierung nicht löschen, während sie läuft.",
    "automations.moduleNotFound": "Modul nicht gefunden",
  ...
  fr: {
    ...
    "automations.discoveredJob.acceptAria": "Accepter l'offre {job}",
    "automations.discoveredJob.dismissAria": "Rejeter l'offre {job}",
    "automations.discoveredJob.viewDetailsAria": "Voir les détails de l'offre {job}",
    "automations.discoveredJob.externalLinkAria": "Ouvrir l'offre {job} sur le site d'origine dans un nouvel onglet",
    ...
    "automations.unknownModule": "Module de site d'emploi inconnu",
    "automations.invalidConnectorParams": "Paramètres de recherche invalides",
    "automations.cannotDeleteRunning": "Vous ne pouvez pas supprimer une automatisation pendant son exécution.",
    "automations.moduleNotFound": "Module introuvable",
  ...
  es: {
    ...
    "automations.discoveredJob.acceptAria": "Aceptar oferta {job}",
    "automations.discoveredJob.dismissAria": "Descartar oferta {job}",
    "automations.discoveredJob.viewDetailsAria": "Ver detalles de la oferta {job}",
    "automations.discoveredJob.externalLinkAria": "Abrir oferta {job} en el sitio original en una nueva pestaña",
    "automations.discoveredJob.errorTitle": "Error",
    ...
    "automations.unknownModule": "Módulo de portal de empleo desconocido",
    "automations.invalidConnectorParams": "Parámetros de búsqueda inválidos",
    "automations.cannotDeleteRunning": "No puedes eliminar una automatización mientras se está ejecutando.",
    "automations.moduleNotFound": "Módulo no encontrado",
