export const staging = {
  en: {
    ...
    "staging.canOnlyDismissStagedReady": "You can only dismiss staged or ready vacancies.",
    "staging.canOnlyRestoreDismissed": "You can only restore dismissed vacancies.",
    "staging.cannotTrashPromoted": "You can't move a promoted vacancy to the trash.",
    "staging.cannotArchivePromoted": "You can't archive a promoted vacancy.",
    "staging.notInTrash": "This vacancy isn't in the trash.",
  ...
  de: {
    ...
    "staging.canOnlyDismissStagedReady": "Du kannst nur bereitgestellte oder fertige Stellen ablehnen.",
    "staging.canOnlyRestoreDismissed": "Du kannst nur abgelehnte Stellen wiederherstellen.",
    "staging.cannotTrashPromoted": "Du kannst eine beförderte Stelle nicht in den Papierkorb verschieben.",
    "staging.cannotArchivePromoted": "Du kannst eine beförderte Stelle nicht archivieren.",
    "staging.notInTrash": "Diese Stelle befindet sich nicht im Papierkorb.",
  ...
  fr: {
    ...
    "staging.canOnlyDismissStagedReady": "Vous ne pouvez rejeter que des offres en attente ou prêtes.",
    "staging.canOnlyRestoreDismissed": "Vous ne pouvez restaurer que des offres rejetées.",
    "staging.cannotTrashPromoted": "Vous ne pouvez pas mettre une offre promue à la corbeille.",
    "staging.cannotArchivePromoted": "Vous ne pouvez pas archiver une offre promue.",
    "staging.notInTrash": "Cette offre n'est pas dans la corbeille.",
  ...
  es: {
    ...
    "staging.canOnlyDismissStagedReady": "Solo puedes rechazar ofertas en espera o listas.",
    "staging.canOnlyRestoreDismissed": "Solo puedes restaurar ofertas rechazadas.",
    "staging.cannotTrashPromoted": "No puedes mover a la papelera una oferta promovida.",
    "staging.cannotArchivePromoted": "No puedes archivar una oferta promovida.",
    "staging.notInTrash": "Esta oferta no está en la papelera.",
