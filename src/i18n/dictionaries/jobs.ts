export const jobs = {
  en: {
    ...
    "jobs.salary": "Salary",
    "jobs.fixedSalary": "Fixed salary",
    "jobs.salaryAmount": "Amount",
    "jobs.salaryMin": "Minimum",
    "jobs.salaryMax": "Maximum",
    "jobs.salaryCurrency": "Currency",
    "jobs.salaryPeriod": "Period",
    "jobs.salaryPeriodNone": "Not specified",
    "jobs.salaryPeriodYearly": "Per year",
    "jobs.salaryPeriodMonthly": "Per month",
    "jobs.salaryPeriodHourly": "Per hour",
    "jobs.bonus": "Bonus",
    "jobs.bonusNone": "No bonus",
    "jobs.bonusFixed": "Fixed amount",
    "jobs.bonusPercentage": "Percentage",
    "jobs.bonusMixed": "Fixed + percentage",
    "jobs.bonusAmount": "Bonus amount",
    "jobs.bonusCondition": "Condition",
    "jobs.bonusConditionPlaceholder": "e.g. after reaching sales goal",
    "jobs.resume": "Resume",
    ...
    "jobs.pickADate": "Pick a date",
    "jobs.clearDate": "Clear date",
    "jobs.selectPreset": "Select Preset",
    "jobs.presetToday": "Today",
    "jobs.presetTomorrow": "Tomorrow",
    "jobs.presetIn3Days": "In 3 days",
    "jobs.presetInAWeek": "In a week",
    "jobs.addNew": "Add New",
  ...
  de: {
    ...
    "jobs.salary": "Gehalt",
    "jobs.fixedSalary": "Festgehalt",
    "jobs.salaryAmount": "Betrag",
    "jobs.salaryMin": "Minimum",
    "jobs.salaryMax": "Maximum",
    "jobs.salaryCurrency": "Währung",
    "jobs.salaryPeriod": "Zeitraum",
    "jobs.salaryPeriodNone": "Nicht angegeben",
    "jobs.salaryPeriodYearly": "Pro Jahr",
    "jobs.salaryPeriodMonthly": "Pro Monat",
    "jobs.salaryPeriodHourly": "Pro Stunde",
    "jobs.bonus": "Bonus",
    "jobs.bonusNone": "Kein Bonus",
    "jobs.bonusFixed": "Fixer Betrag",
    "jobs.bonusPercentage": "Prozentual",
    "jobs.bonusMixed": "Fix + Prozent",
    "jobs.bonusAmount": "Bonusbetrag",
    "jobs.bonusCondition": "Bedingung",
    "jobs.bonusConditionPlaceholder": "z. B. nach Erreichen des Verkaufsziels",
    ...
    "jobs.pickADate": "Datum wählen",
    "jobs.clearDate": "Datum entfernen",
    "jobs.selectPreset": "Vorauswahl",
    "jobs.presetToday": "Heute",
    "jobs.presetTomorrow": "Morgen",
    "jobs.presetIn3Days": "In 3 Tagen",
    "jobs.presetInAWeek": "In einer Woche",
  ...
  fr: {
    ...
    "jobs.salary": "Salaire",
    "jobs.fixedSalary": "Salaire fixe",
    "jobs.salaryAmount": "Montant",
    "jobs.salaryMin": "Minimum",
    "jobs.salaryMax": "Maximum",
    "jobs.salaryCurrency": "Devise",
    "jobs.salaryPeriod": "Période",
    "jobs.salaryPeriodNone": "Non précisé",
    "jobs.salaryPeriodYearly": "Par an",
    "jobs.salaryPeriodMonthly": "Par mois",
    "jobs.salaryPeriodHourly": "Par heure",
    "jobs.bonus": "Prime",
    "jobs.bonusNone": "Aucune prime",
    "jobs.bonusFixed": "Montant fixe",
    "jobs.bonusPercentage": "Pourcentage",
    "jobs.bonusMixed": "Fixe + pourcentage",
    "jobs.bonusAmount": "Montant de la prime",
    "jobs.bonusCondition": "Condition",
    "jobs.bonusConditionPlaceholder": "ex. après avoir atteint l'objectif de vente",
    "jobs.resume": "CV",
    ...
    "jobs.pickADate": "Choisir une date",
    "jobs.clearDate": "Effacer la date",
    "jobs.selectPreset": "Sélectionner un preset",
    "jobs.presetToday": "Aujourd'hui",
    "jobs.presetTomorrow": "Demain",
    "jobs.presetIn3Days": "Dans 3 jours",
    "jobs.presetInAWeek": "Dans une semaine",
    "jobs.addNew": "Ajouter",
  ...
  es: {
    ...
    "jobs.salary": "Salario",
    "jobs.fixedSalary": "Salario fijo",
    "jobs.salaryAmount": "Importe",
    "jobs.salaryMin": "Mínimo",
    "jobs.salaryMax": "Máximo",
    "jobs.salaryCurrency": "Moneda",
    "jobs.salaryPeriod": "Período",
    "jobs.salaryPeriodNone": "No especificado",
    "jobs.salaryPeriodYearly": "Por año",
    "jobs.salaryPeriodMonthly": "Por mes",
    "jobs.salaryPeriodHourly": "Por hora",
    "jobs.bonus": "Bonus",
    "jobs.bonusNone": "Sin bonus",
    "jobs.bonusFixed": "Importe fijo",
    "jobs.bonusPercentage": "Porcentaje",
    "jobs.bonusMixed": "Fijo + porcentaje",
    "jobs.bonusAmount": "Importe del bonus",
    "jobs.bonusCondition": "Condición",
    "jobs.bonusConditionPlaceholder": "p. ej. tras alcanzar el objetivo de ventas",
    ...
    "jobs.pickADate": "Elegir fecha",
    "jobs.clearDate": "Borrar fecha",
    "jobs.selectPreset": "Seleccionar preset",
    "jobs.presetToday": "Hoy",
    "jobs.presetTomorrow": "Mañana",
    "jobs.presetIn3Days": "En 3 días",
    "jobs.presetInAWeek": "En una semana",
    "jobs.addNew": "Agregar",
