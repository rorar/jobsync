...
INSERT INTO "new_Job" ("applied", "appliedDate", "automationId", "companyId", "createdAt", "description", "discoveredAt", "discoveryStatus", "dueDate", "id", "jobSourceId", "jobTitleId", "jobType", "jobUrl", "locationId", "matchData", "matchScore", "resumeId", "salaryBonus", "salaryCurrency", "salaryMax", "salaryMin", "salaryPeriod", "salaryRange", "sortOrder", "statusId", "userId", "version") SELECT "applied", "appliedDate", "automationId", "companyId", "createdAt", "description", "discoveredAt", "discoveryStatus", "dueDate", "id", "jobSourceId", "jobTitleId", "jobType", "jobUrl", "locationId", "matchData", "matchScore", "resumeId", "salaryBonus", "salaryCurrency", "salaryMax", "salaryMin", "salaryPeriod", "salaryRange", "sortOrder", "statusId", "userId", "version" FROM "Job";
DROP TABLE "Job";
