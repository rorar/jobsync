...
**Total: 599 bugs found, 596 fixed, 4 open (2 accepted risk + 2 new), 2 new**

### Status: ⚠️ 2 NEW open (IT-B1, IT-B3; IT-B2 + IT-B4 fixed 2026-08-19 in the §F referral-events work) + 2 known issues (accepted risk, pre-existing) + 1 deferred cross-cutting (H-P-09 observability)
